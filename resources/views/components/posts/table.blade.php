{{-- ini untuk fungsi Toas pesan upload/+data post success --}}
...
<section class="p-3 sm:p-5 antialiased">
    <h2 class="text-sm font-semibold pl-4 mb-4"> post by: {{ Auth::user()->name }}</h2>
    <div class="max-w-screen-xl px-4 ">
        <!-- Start coding here -->
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-satart space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <a href="/dashboard/create" type="button" id="createProductModalButton1"
                        ...
                        @foreach ($posts as $post)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="psot-{{ $post->id }}-button"
                                        data-dropdown-toggle="psot-{{ $post->id }}-dropdown"
